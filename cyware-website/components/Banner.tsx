...
export function Banner() {
  return (
    <div className="fixed top-0 left-0 w-full h-10 z-50 bg-[#004efc] text-white py-2 px-4 text-center text-sm flex flex-col sm:flex-row justify-center items-center gap-2 sm:gap-4 shadow-lg">
